...
```
composer require p2made/yii2-sb-admin-theme "^2.1"
```

or

```
php composer.phar require p2made/yii2-sb-admin-theme "^2.1"
```

Alternatively add:

```
	"p2made/yii2-sb-admin-theme": "^2.1"
```
