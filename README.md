...
```
composer require p2made/yii2-sb-admin-theme ">=1.3.1"
```

or

```
php composer.phar require p2made/yii2-sb-admin-theme ">=1.3.1"
```

Alternatively add:

```
"p2made/yii2-sb-admin-theme": ">=1.3.1"
```
